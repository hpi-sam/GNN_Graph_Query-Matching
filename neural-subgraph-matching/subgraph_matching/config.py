...
def parse_encoder(parser, arg_str=None):
    ...
    enc_parser.add_argument('--use-features', action="store_true",
                            help='whether to use node features in training')
    enc_parser.add_argument('--use-curriculum', action="store_true",
                            help='whether to use curriculum learning in training')
